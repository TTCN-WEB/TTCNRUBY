class FarmersController < ApplicationController
  ...
  if current_user
	...
	@farmer = Farmer.new(params.permit(:email, :farm, :name, :produce, :produce_price, :wepay_access_token, :wepay_account_id, :password))
  end
  ...
  # POST /farmers
def create
  @farmer = Farmer.new(params.require(:farmer).permit(:email, :farm, :name, :produce, :produce_price, :wepay_access_token, :wepay_account_id, :password))
